...
const provider = {
  ...
  provider: LobeLogtoProvider({
    ...
    clientId: authEnv.AUTH_LOGTO_ID ?? authEnv.LOGTO_CLIENT_ID,
    clientSecret: authEnv.AUTH_LOGTO_SECRET ?? authEnv.LOGTO_CLIENT_SECRET,
    issuer: authEnv.AUTH_LOGTO_ISSUER ?? authEnv.LOGTO_ISSUER,
  }),
};
